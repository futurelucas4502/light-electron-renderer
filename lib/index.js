...
function renderTemplate(fileName) {
    return new Promise(function (resolve, reject) {
        try {
            ...
            rendererAction(filePath, currentViewData, options, function (renderedHTML) {
                resolve({
                    mimeType: 'text/html',
...
function use(renderer, useAssets, assetFolderPath, viewsFolderPath, renderFunction, name, permOptions) {
